...
SP500_HASH_TABLE = {
    ...
    'DISCA' =>	['Discovery Inc. Class A', 'Consumer Discretionary'],
    'DISCK' =>	['Discovery Inc. Class C', 'Consumer Discretionary'],
    ...
    'TTWO' =>	['Take-Two Interactive', 'Information Technology'],
